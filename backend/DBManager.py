...
class DBManager(object):
    ...
    def create_tables(self):
        ...
        c.execute('''CREATE TABLE IF NOT EXISTS MESSAGE_ATTACHMENT
                     (ID INTEGER PRIMARY KEY AUTOINCREMENT, MESSAGE_ID INTEGER NOT NULL, TYPE TEXT NOT NULL, ATTACHMENT TEXT NOT NULL
